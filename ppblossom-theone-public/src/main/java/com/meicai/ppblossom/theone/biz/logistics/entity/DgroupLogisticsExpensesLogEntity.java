...
public class DgroupLogisticsExpensesLogEntity  implements Serializable  {
	/**
	 * 序列化
	 */
	...
	* 深度复制
	*/
	public  DgroupLogisticsExpensesLogEntity deepClone() {
		DgroupLogisticsExpensesLogEntity entity = new DgroupLogisticsExpensesLogEntity();
	...
	public String toString() {
		return "DgroupLogisticsExpensesLogEntity{"
        	+ " \"id\":" + this.getId() +","
