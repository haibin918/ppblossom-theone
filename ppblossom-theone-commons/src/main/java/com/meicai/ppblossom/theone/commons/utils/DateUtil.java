...
public class DateUtil {
     ...
     * 根据两个时间戳计算期间相差天数
     */
    public static int getDiffDayByTime(long startTime, long endTime) {
        int day = 0;
        if (endTime <= startTime) {
            return day;
        }
        try {
            double temp = new BigDecimal(endTime - startTime).divide(new BigDecimal(3600 * 24), 1, BigDecimal.ROUND_HALF_UP).doubleValue();
            day = (int) Math.ceil(temp);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return day;
     ...
     * @throws ParseException
     */
    public static String getTodayDateString() throws ParseException {
     ...
     * @throws ParseException
     */
    public static Long getLastMonthString(int lastMonth) throws ParseException {
     ...
     * @throws ParseException
     */
    public static Long getLastMonthillisecondString(int lastMonth) {
        Calendar c = Calendar.getInstance();
        c.setTime(new Date());
        c.add(Calendar.MONTH, -lastMonth);
     ...
     * @return
     */
    public static Long StringToMsTime(String time, String format) {
        if (StringUtils.isEmpty(time)) {
            return 0L;
        }
        Long result = null;
    ...
    //获得本周一0点时间
    public static Long getTimesWeekmorningLong() {
        Calendar cal = Calendar.getInstance();
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY), cal.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
        cal.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY);
        return cal.getTimeInMillis();
    ...
    //获得本周日24点时间
    public static Long getTimesWeeknightLong() {
        Calendar cal = Calendar.getInstance();
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY), cal.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
        cal.set(Calendar.DAY_OF_WEEK, Calendar.MONDAY);
    ...
    //获得本月第一天0点时间
    public static Long getTimesMonthmorningLong() {
        Calendar cal = Calendar.getInstance();
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY), cal.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
        cal.set(Calendar.DAY_OF_MONTH, cal.getActualMinimum(Calendar.DAY_OF_MONTH));
        return cal.getTimeInMillis();
    ...
    //获得本月最后一天24点时间
    public static Long getTimesMonthnightLong() {
        Calendar cal = Calendar.getInstance();
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY), cal.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
        cal.set(Calendar.DAY_OF_MONTH, cal.getActualMaximum(Calendar.DAY_OF_MONTH));
        cal.set(Calendar.HOUR_OF_DAY, 24);
    ...
    public static String getCurrTimestamp() {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd-HHmmss"); // yyyyMMddddhhmmssSSS
        Date currentTime = new Date();
    ...
    public static String getCronDateStr(final String cron) {
        String dateStr = "";
        ...
        try {
            date = sdf.parse(cron);
            dateStr = DateUtil.formatDateToString(date, "HH:mm:ss");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return dateStr;
    ...
    public static String getLastDate(int days) {
        ...
        String lastdayDate = dateFormat.format(calendar.getTime());
     ...
     * @return
     */
    public static int getHoursTime(int hour,int minute) {
        Calendar cal = Calendar.getInstance();
